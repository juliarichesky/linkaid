...
const typeOptions = [
  ...
  {
    value: TIPO_CONTATO_LABELS.SOLICITANTE,
    label: TIPO_CONTATO_LABELS.SOLICITANTE,
  },
  {
    value: TIPO_CONTATO_LABELS.BENEFICIARIO,
    label: TIPO_CONTATO_LABELS.BENEFICIARIO,
  },
];
...
export default function CreateTicket() {
  ...
  const handleCreate = async () => {
    if (!name || !subject || !priority || !channel) {
      toast.error(
        "Preencha os campos obrigatórios: Nome, Assunto, Canal e Prioridade",
      );
      return;
    }
    ...
    <Card className="shadow-sm">
      <CardHeader>
        <CardTitle className="text-base">
          Dados do {tab === "pf" ? "Paciente" : "Empresa"}
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <Label>{tab === "pf" ? "Nome Completo" : "Razão Social"}</Label>
            <Input
              placeholder={
                tab === "pf"
          ...
          <div>
            ...
            <Input
              placeholder={
                tab === "pf" ? "000.000.000-00" : "00.000.000/0000-00"
              }
              value={doc}
              onChange={(e) =>
                setDoc(
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            <Label>Cidade</Label>
            <Input
              placeholder="Cidade do remetente"
              value={city}
        ...
        <div>
          <Label>Assunto *</Label>
          <Input
            placeholder="Assunto principal do ticket"
            value={subject}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Select value={responsible} onValueChange={setResponsible}>
              ...
              <SelectContent>
                {loading && (
                  <SelectItem value="loading-responsibles" disabled>
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-5 animate-fade-in">
      <Button
        variant="ghost"
        size="sm"
        onClick={() => navigate(platformPath("/tickets"))}
      >
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          {loading
            ? "Carregando opções de atendimento..."
            : "Cadastro manual de atendimento"}
        </p>
      </div>
