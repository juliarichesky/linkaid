...
const Select = ({
  ...
  return (
    <SelectContext.Provider
      value={{ value: activeValue, setValue, open, setOpen, items }}
    >
...
const SelectValue = ({ placeholder }: { placeholder?: React.ReactNode }) => {
  ...
  if (shouldShowPlaceholder || !context?.value)
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ...
      role="listbox"
      className={cn(
        "absolute left-0 top-full z-50 mt-1 max-h-96 min-w-full overflow-auto rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-0 zoom-in-95",
        className,
      )}
      {...props}
    >
