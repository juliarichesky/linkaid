...
const mockMessages: Record<string, Message[]> = {
  "Carlos Silva": [
    {
      from: "Carlos Silva",
      text: "Oi Ana, o ticket TKT-004 é urgente!",
      time: "14:20",
      avatar: "CS",
    },
    {
      from: "Você",
      text: "Entendi, vou priorizar agora.",
      time: "14:22",
      avatar: "VC",
    },
    {
      from: "Carlos Silva",
      text: "Ótimo! O paciente está aguardando retorno.",
      time: "14:23",
      avatar: "CS",
    },
  ],
  "Maria Santos": [
    {
      from: "Maria Santos",
      text: "Triagem do lote de hoje está pronta.",
      time: "10:15",
      avatar: "MS",
    },
  ...
  Triagem: [
    {
      from: "Maria Santos",
      text: "Equipe, temos 5 novos tickets para triagem.",
      time: "09:00",
      avatar: "MS",
    },
    {
      from: "Carlos Silva",
      text: "Já estou assumindo 2.",
      time: "09:05",
      avatar: "CS",
    },
    {
      from: "Você",
      text: "Fico com os outros 3.",
      time: "09:08",
      avatar: "VC",
    },
    {
      from: "Maria Santos",
      text: "Perfeito! Vamos manter o ritmo.",
      time: "09:10",
      avatar: "MS",
    },
  ],
  Gestão: [
    {
      from: "Ana Costa",
      text: "Reunião de alinhamento às 15h.",
      time: "08:30",
      avatar: "AC",
    },
...
export function TeamPanel({ open, onClose }: TeamPanelProps) {
  ...
  const handleCreateGroup = () => {
    ...
    setGroups([
      ...groups,
      { id: groups.length + 1, name: newGroupName.trim() },
    ]);
    setNewGroupName("");
          ...
          <div className="flex items-center gap-2 flex-1 min-w-0">
            {chatTarget.type === "group" ? (
              ...
              <div className="relative shrink-0">
                ...
                <Circle
                  className={cn(
                    "w-2.5 h-2.5 absolute -bottom-0.5 -right-0.5 fill-current stroke-card stroke-2",
                    teammates.find((t) => t.name === chatTarget.name)?.online
                      ? "text-success"
          ...
          {currentMessages.map((m, i) => {
            ...
            return (
              ...
              >
                ...
                >
                  {!isMe && (
                    <p className="text-[10px] font-semibold text-primary px-1">
                      {m.from}
                    </p>
                  )}
                  <div
              ...
              <div className="space-y-0.5">
                {onlineTeammates.map((t) => (
                  <button
                    ...
                    onClick={() =>
                      setChatTarget({ type: "person", name: t.name })
                    }
                  >
                    <div className="relative shrink-0">
