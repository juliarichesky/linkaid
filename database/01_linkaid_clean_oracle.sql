-- LINKAID - BANCO LIMPO
-- Script Oracle SQL para criar o banco do zero no estado final esperado.
--
-- Ordem geral:
-- 1. remover tabelas antigas, se existirem;
-- 2. criar tabelas de dominio;
-- 3. criar tabelas operacionais;
-- 4. carregar dominios;
-- 5. carregar dados de demonstracao respeitando as chaves estrangeiras;
-- 6. executar consultas de validacao.
--
-- Regra de negocio para contatos:
-- - todo contato que chega pedindo ajuda, triagem, consulta ou acolhimento
--   nasce como SOLICITANTE;
-- - BENEFICIARIO continua sendo um tipo selecionavel pelos atendentes, mas
--   deve ser usado apenas quando o solicitante ja foi ou esta sendo atendido
--   por dentista afiliado a Turma do Bem.
